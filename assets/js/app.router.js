angular.module('app').config(["$locationProvider", "$stateProvider", "$urlRouterProvider", function ($locationProvider, $stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('home', {
        ...
        templateUrl: 'assets/html/admin/account/info.html?rev=703084e925',
        data: {
            projectHide: true,
            title: '帐号管理'
        },
        ...
        url: '/info',
        templateUrl: 'assets/html/admin/billingservice/info.html?rev=e9e2546ad4',
        data: {
            title: '计费策略'
        },
        ...
        url: '/info',
        templateUrl: 'assets/html/admin/department/info.html?rev=cec10ca4ca',
        data: {
            title: '户管理'
        },
        ...
        templateUrl: 'assets/html/admin/department/amount.html?rev=febb16fd21',
        data: {
            projectDisabled: true,
            title: '充值'
        },
        ...
        templateUrl: 'assets/html/admin/property/record.html?rev=79f5148759',
        data: {
            title: '收支明细'
        },
        ...
        url: '/statement/:tab',
        templateUrl: 'assets/html/admin/property/statement.html?rev=3d69773cb0',
        data: {
            title: '对账单'
        },
        ...
        url: '/consume',
        templateUrl: 'assets/html/admin/property/consume.html?rev=5edcb466fc',
        data: {
            title: '消耗明细'
        },
