angular.module('app').config(["$locationProvider", "$stateProvider", "$urlRouterProvider", function($locationProvider, $stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('home', {
        ...
        url: '/dashboard',
        templateUrl: 'assets/html/dash.html?rev=b7f91471ad',
        data: {
            projectHide: true,
        ...
        templateUrl: 'assets/html/admin/character/manage.html?rev=e2c7235375',
        resolve: {
            deps: ["$ocLazyLoad", function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    insertBefore: '#load_styles_before',
        ...
        url: '/create',
        templateUrl: 'assets/html/admin/project/create.html?rev=81556b33f7',
        data: {
            projectHide: true,
            title: '创建项目'
        },
        ...
        url: '/edit/:id',
        templateUrl: 'assets/html/admin/project/edit.html?rev=514876ae16',
        data: {
            projectHide: true,
            title: '编辑项目'
        },
        ...
        templateUrl: 'assets/html/admin/account/info.html?rev=89538ef664',
        data: {
            projectHide: true,
            title: '账户管理'
        },
        ...
        templateUrl: 'assets/html/admin/account/create.html?rev=2f0926a077',
        data: {
            projectHide: true,
            title: '新建账户'
        },
        ...
        templateUrl: 'assets/html/admin/account/edit.html?rev=ab058fc974',
        data: {
            projectHide: true,
            title: '编辑账户'
        },
        ...
        templateUrl: 'assets/html/admin/account/roleres.html?rev=5025cfdad7',
        data: {
            projectHide: true,
            title: '账户权限'
        },
        ...
        url: '/manage/:id',
        templateUrl: 'assets/html/admin/billingservice/manage.html?rev=9ce291753b',
        data: {
        ...
        url: '/add',
        templateUrl: 'assets/html/admin/billingservice/add.html?rev=f6c58c61dc',
        data: {
            projectDisabled: true,
            title: '添加策略'
        },
        ...
        templateUrl: 'assets/html/admin/urlpath/index.html?rev=9b5dee6afa',
        data: {
            projectHide: true,
            title: '地址管理'
        },
        ...
        url: '/edit/:id',
        templateUrl: 'assets/html/admin/building/edit.html?rev=c9e922d3a4',
        data: {
            projectDisabled: true,
            title: '编辑'
        },
        ...
        url: '/create',
        templateUrl: 'assets/html/admin/building/create.html?rev=edd56160dc',
        data: {
            projectDisabled: true,
            title: '添加'
        },
        ...
        url: '/create',
        templateUrl: 'assets/html/admin/department/create.html?rev=db71fbdd4e',
        data: {
            projectDisabled: true,
            title: '添加户'
        },
        ...
        templateUrl: 'assets/html/admin/department/amount.html?rev=9f2a0fbf8e',
        data: {
            projectDisabled: true,
            title: '充值'
        },
        ...
        url: '/create',
        templateUrl: 'assets/html/admin/collector/simple.html?rev=fade6f9787',
        ...
        url: '/index',
        templateUrl: 'assets/html/admin/energy/index.html?rev=21ef96c8a2',
        data: {
            title: '能耗分类'
        },
        ...
        url: '/add',
        templateUrl: 'assets/html/admin/energycategory/add.html?rev=7a3d3438ff',
        data: {
            projectHide: true,
            title: '添加配置'
        },
        ...
        url: '/update/:id',
        templateUrl: 'assets/html/admin/energycategory/update.html?rev=4347c5d585',
        data: {
            projectHide: true,
            title: '编辑配置'
        },
        ...
        url: '/add',
        templateUrl: 'assets/html/admin/eventcategory/add.html?rev=2519e20be6',
        data: {
            projectDisabled: true,
            title: '事件添加'
        },
        ...
        url: '/update/:id',
        templateUrl: 'assets/html/admin/eventcategory/update.html?rev=74495db792',
        data: {
            projectDisabled: true,
            title: '事件编辑'
        },
        ...
        views: {
            '@admin.finance': {
                templateUrl: 'assets/html/admin/finance/project/withdraw.html?rev=6627f300bc',
